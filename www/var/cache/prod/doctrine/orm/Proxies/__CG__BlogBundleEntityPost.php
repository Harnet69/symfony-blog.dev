...
class Post extends \BlogBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'BlogBundle\\Entity\\Post' . "\0" . 'title', '' . "\0" . 'BlogBundle\\Entity\\Post' . "\0" . 'description', '' . "\0" . 'BlogBundle\\Entity\\Post' . "\0" . 'datetime'];
        }
